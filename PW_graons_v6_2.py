...
df_top = pd.read_excel('Pegase2869.xlsx', sheet_name='Topologia')  # dades de la topologia
df_bus = pd.read_excel('Pegase2869.xlsx', sheet_name='Busos')  # dades dels busos
...
for i in range(n):  # de la pestanya busos
    Yshunts[df_bus.iloc[i, 0]] += df_bus.iloc[i, 6]  # part real
    Yshunts[df_bus.iloc[i, 0]] += df_bus.iloc[i, 7] * 1j  # part imaginària
